  ...
  return (
    <header className='flex justify-between items-center h-20 bg-gray-900'>
      ...
      <div className='flex items-center'>
        <button onClick={() => window.location.href = '/admin'} className='hover:scale-105 text-white px-6 py-2 rounded-full text-sm font-semibold mr-8 flex items-center cursor-pointer  transition duration-300 ease-in-out'>
          <span className='text-purple-400 text-xl font-semibold'>Login</span>
        </button>  
